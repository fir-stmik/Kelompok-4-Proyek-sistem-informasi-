...
$query1 = mysqli_query($koneksi, "select count(*) as jumlah_buku from tb_buku" );

$query2 = mysqli_query($koneksi, "select count(*) as jumlah_pengujung from tb_pengujung");


$buku = mysqli_fetch_assoc($query1);
$pengujung = mysqli_fetch_assoc($query2);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="display-2">Welcome back <?= $_SESSION['user']['username']?> !!</h1>
            <hr>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?= $pengujung['jumlah_pengujung'] ?></sup></h3>
