    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <form style="margin-left: 20px;" >
            <input style="border: 1px solid rgba(0,0,0,.2);" type="text" name="search">
            <button style="margin-left: 10px; border: 1px solid rgba(0,0,0,.2);" type="submit" name="search">Cari</button>
          </form><br>

          <table border="0" cellpadding="10" cellspacing="0" width="80%"  >
            
            <tr style="background-color: rgb(210,210,210); font-weight: bold;">
